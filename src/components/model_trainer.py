...
from src.utiles import evaluate_models
...
class ModelTrainer:
    ...
    def  initiate_model_trainer(self,train_arr,test_arr):
        try:
            logging.info("Preparing the dataset split X_train y_train X_test y_test for model traing")
            ...
            logging.info(f"Best found model on both training and testing dataset model report= {model_report} \n best mode scode ={best_model_score} \n best model name={best_model_name} \n best mode={best_model}")
